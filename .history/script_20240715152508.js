...
function create() {
    ...
    const areas = [
        { x: 282, y: 199, width: 365 - 282, height: 272 - 199 },  // coords="365,199,282,272"
        { x: 624, y: 186, width: 680 - 624, height: 288 - 186 },  // coords="624,186,680,288"
        { x: 705, y: 316, width: 790 - 705, height: 404 - 316 },  // coords="705,316,790,404"
        { x: 196, y: 321, width: 311 - 196, height: 403 - 321 },  // coords="196,321,311,403"
        { x: 594, y: 343, width: 679 - 594, height: 427 - 343 }   // coords="594,343,679,427"
    ];
