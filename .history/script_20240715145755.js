...
function create() {
    ...
    this.input.on('pointerdown', (pointer) => {
        ...
        areas.forEach((area) => {
            ...
            {
                displaySadPanda(this.area.x, area.y);
            }
        });
...
function displaySadPanda(scene, x, y){
    const sadPanda = scene.add.image(x,y,'sad').setScale(0.5);
    setTimeout(() =>{sadPanda.destroy();},1000);
}
